...
<body id="kt_body" style="background-image: url('{{ asset('assets/media/patterns/header-bg.png') }}');"
                ...
                <div id="kt_header" class="header align-items-stretch" data-kt-sticky="true"
                    ...
                    <div class="container-xxl d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            <a href="{{ route('admin.users') }}" class="btn btn-bg btn-outline-light">
                                Users
                            </a>
                            ...
                            <form method="POST" action="{{ route('logout') }}" id="logoutForm"
                                ...
                                @csrf
                                <button type="submit" class="btn btn-bg btn-outline-light" title="Logout">
                                    Logout
                                </button>
                            </form>
                        </div>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-L98VPZFG7E"></script>
